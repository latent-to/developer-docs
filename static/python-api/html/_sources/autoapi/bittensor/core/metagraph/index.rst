...
.. py:class:: AsyncMetagraph(netuid, network = settings.DEFAULT_NETWORK, lite = True, sync = True, subtensor = None, mechid = 0)
...
.. py:data:: METAGRAPH_STATE_DICT_NDARRAY_KEYS
   :value: ['version', 'n', 'block', 'stake', 'ranks', 'trust', 'consensus', 'validator_trust',...
...
.. py:class:: Metagraph(netuid, network = settings.DEFAULT_NETWORK, lite = True, sync = True, subtensor = None, mechid = 0)
...
.. py:class:: MetagraphMixin(netuid, network = settings.DEFAULT_NETWORK, lite = True, sync = True, subtensor = None, mechid = 0)
...
.. py:class:: NonTorchMetagraph(netuid, network = settings.DEFAULT_NETWORK, lite = True, sync = True, subtensor = None, mechid = 0)
...
.. py:class:: TorchMetagraph(netuid, network = settings.DEFAULT_NETWORK, lite = True, sync = True, subtensor = None, mechid = 0)
