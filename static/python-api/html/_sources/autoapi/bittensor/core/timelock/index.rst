...
.. py:module:: bittensor.core.timelock
...
.. autoapisummary::
   ...
   bittensor.core.timelock.decrypt
   bittensor.core.timelock.encrypt
   bittensor.core.timelock.wait_reveal_and_decrypt
...
.. py:function:: decrypt(encrypted_data, no_errors = True, return_str = False)
   ...
   :param return_str: convert decrypted data to string if `True`. Default is `False`.
...
.. py:function:: encrypt(data, n_blocks, block_time = 12.0)
   ...
   :param block_time: Time in seconds for each block. Default is `12.0` seconds.
