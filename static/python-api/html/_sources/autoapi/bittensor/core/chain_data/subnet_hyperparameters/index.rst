...
.. py:class:: SubnetHyperparameters
   ...
   :ivar commit_reveal_period: Interval for commit-reveal weights.
   :vartype commit_reveal_period: int
   ...
   :ivar alpha_sigmoid_steepness:
   :vartype alpha_sigmoid_steepness: float
   :ivar yuma_version: Version of yuma.
   :vartype yuma_version: int
   :ivar subnet_is_active: Indicates if subnet is active after START CALL.
   :vartype subnet_is_active: bool
   :ivar transfers_enabled: Flag indicating if transfers are enabled.
   :vartype transfers_enabled: bool
   :ivar bonds_reset_enabled: Flag indicating if bonds are reset enabled.
   :vartype bonds_reset_enabled: bool
   :ivar user_liquidity_enabled: Flag indicating if user liquidity is enabled.

   :vartype user_liquidity_enabled: bool
   ...
   .. py:attribute:: alpha_sigmoid_steepness
      :type:  float
   ...
   .. py:attribute:: bonds_reset_enabled
      :type:  bool
   ...
   .. py:attribute:: transfers_enabled
      :type:  bool


   .. py:attribute:: user_liquidity_enabled
      :type:  bool
