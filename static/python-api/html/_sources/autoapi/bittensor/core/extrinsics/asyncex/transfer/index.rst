...
.. py:function:: transfer_extrinsic(subtensor, wallet, dest, amount, transfer_all = False, wait_for_inclusion = True, wait_for_finalization = False, keep_alive = True, period = None)
   :async:
   ...
   :type dest: str
   :param amount: Amount to stake as Bittensor balance. `None` if
                  transferring all.
   :type amount: Optional[bittensor.utils.balance.Balance]
