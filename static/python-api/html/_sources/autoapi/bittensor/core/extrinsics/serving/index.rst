...
.. py:function:: do_serve_axon(subtensor, wallet, call_params, wait_for_inclusion = False, wait_for_finalization = True, period = None)
...
.. py:function:: get_last_bonds_reset(subtensor, netuid, hotkey, block = None)
   ...
   :type netuid: int
   :param hotkey: The hotkey of the neuron for which to fetch the last bonds reset.
   :type hotkey: str
   :param block: The block number to query. If ``None``, the latest block is used.
   :type block: Optional[int]

   :returns: The last bonds reset data for the specified hotkey and netuid.
   :rtype: bytes
...
.. py:function:: publish_metadata(subtensor, wallet, netuid, data_type, data, wait_for_inclusion = False, wait_for_finalization = True, period = None, reset_bonds = False)
   ...
   :param period: The number of blocks during which the transaction will remain valid after it's submitted. If
                  ...
                  You can think of it as an expiration date for the transaction.
   :type period: Optional[int]
   :param reset_bonds: If `True`, the function will reset the bonds for the neuron. Defaults to `False`.
   :type reset_bonds: bool
...
.. py:function:: serve_axon_extrinsic(subtensor, netuid, axon, wait_for_inclusion = False, wait_for_finalization = True, certificate = None, period = None)
...
.. py:function:: serve_extrinsic(subtensor, wallet, ip, port, protocol, netuid, placeholder1 = 0, placeholder2 = 0, wait_for_inclusion = False, wait_for_finalization=True, certificate = None, period = None)
