...
The `sphinx-starter` directory contains a pre-configured setup. Install required packages:
...
2. Replace the entire `static/python-api/html` directory:
   ...
   cp -r /path/to/sphinx-starter/build/html static/python-api/html
   ```
...
See `docs/bt-api-ref.md` for examples.
