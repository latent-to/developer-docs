...
Start with: [Proxies: Overview](./index.md).
...
See [Slippage](../../staking-and-delegation/slippage.md).
...
- Prefer scoped proxy types and non-zero delay for any delegate that can touch meaningful stake. See [Proxies: Overview](./index.md) and [Working with Proxies](./working-with-proxies.md).
...
- Keep the custody coldkey off hot workstations; follow the best practices described in [Coldkey and Hotkey Workstation Security](../coldkey-hotkey-security.md).
- Revoke proxies you are not actively using if you do not want ongoing monitoring burden.

## Learn more

- [Proxies: Overview](./index.md) (main proxy documentation)
- [Working with Proxies](./working-with-proxies.md)
- [Coldkey and Hotkey Workstation Security](../coldkey-hotkey-security.md)
- [Slippage](../../staking-and-delegation/slippage.md)
- [Price protection](../../staking-and-delegation/price-protection.md)
