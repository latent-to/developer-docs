...
For full coverage of the `Wallet` and `Keypair` classes, including key types, regeneration from mnemonics, and at-rest encryption, see [Wallet scripting](./btwallet/index.md).
