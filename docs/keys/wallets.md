...
You can’t use the same hotkey for multiple UIDs within a single subnet. However, you can reuse the same hotkey for UIDs that belong to different subnets.
