...
This guide uses Opentensor's [_subnet template_](https://github.com/RaoFoundation/subnet-template/tree/main) repo. The repo provides a minimal implementation for building a custom subnet on the Bittensor network and includes the core logic for the miner and validator.
...
```sh
git clone https://github.com/RaoFoundation/subnet-template.git
cd subnet-template
```
