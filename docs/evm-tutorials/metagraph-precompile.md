...
- **Source code**: [MetagraphPrecompile reference](https://github.com/RaoFoundation/subtensor/blob/main/precompiles/src/metagraph.rs)
...
console.log(
  `Neuron ${uid} - Stake: ${stake}, Emission: ${emission}, Trust: ${trust}`,
);
```
