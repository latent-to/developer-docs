...
- [Bittensor EVM Starter Project](https://github.com/subquery/ethereum-subql-starter/tree/main/Bittensor/bittensor-starter)
- [Bittensor Substrate Starter Project](https://github.com/subquery/subql-starter/tree/main/Bittensor/bittensor-starter)

For technical questions and support reach out to us `start@subquery.network`

### Running and Hosting your Bittensor SubQuery APIs
