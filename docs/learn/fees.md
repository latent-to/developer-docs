...
- [`add_stake`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L591)
- [`remove_stake`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L635)
- [`add_stake_limit`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1793)
- [`remove_stake_limit`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1857)
- [`remove_stake_full_limit`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L2081)
- [`move_stake`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1643)
- [`transfer_stake`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1686)
- [`swap_stake`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1731)
- [`swap_stake_limit`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1904)
- [`unstake_all`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1581)
- [`unstake_all_alpha`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1614)

#### Wallet and Identity Management

- [`set_identity`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1471)
- [`set_subnet_identity`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1513)
- [`try_associate_hotkey`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1938)
- [`schedule_swap_coldkey`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1333)
- [`set_coldkey_auto_stake_hotkey`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L2132)

#### Registration

- [`register`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L895)
- [`root_register`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1037)
- [`burned_register`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L930)

#### Subnet Management

- [`register_network`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1231)
- [`register_network_with_identity`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1440)
- [`start_call`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1963)
- [`update_symbol`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L2163)

#### Burn/Recycle Alpha

- [`recycle_alpha`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L2027)
- [`burn_alpha`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L2052)

#### Child Hotkey Management

- [`set_children`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1287)
- [`set_childkey_take`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1021)

#### Governance

- [`adjust_senate`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L921)
- [`claim_root`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L2254)
- [`set_root_claim_type`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L2289)
...
**Weight fee** — source: [`pallets/transaction-fee/src/lib.rs:44-56`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/transaction-fee/src/lib.rs#L44-L56)
...
**Length fee** — runtime config sets [`LengthToFee = IdentityFee`](https://github.com/RaoFoundation/subtensor/blob/main/runtime/src/lib.rs#L564): 1 rao per byte of the encoded extrinsic. Source: [`runtime/src/lib.rs`](https://github.com/RaoFoundation/subtensor/blob/main/runtime/src/lib.rs) and the [FRAME Transaction Payment pallet](https://docs.substrate.io/reference/frame-pallets/transaction-payment/).
...
- [Fee value](https://github.com/RaoFoundation/subtensor/blob/main/pallets/swap/src/pallet/mod.rs#L68-L76)
- [Fee calculation and distribution](https://github.com/RaoFoundation/subtensor/blob/main/pallets/swap/src/pallet/impls.rs#L596-L639)
...
- [`set_weights`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L83) - Setting validator weights
- [`commit_weights`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L158) - Commit weight hash
- [`batch_commit_weights`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L192) - Batch commit weight hashes
- [`reveal_weights`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L241) - Reveal committed weights
- [`commit_crv3_weights`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L285) - Commit CRv3 encrypted weights
- [`batch_reveal_weights`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L337) - Batch reveal committed weights
...
The `pays_fee` for the entire batch is determined by [`weight_and_dispatch_class`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/utility/src/lib.rs#L606-L618):
...
**Source code:** `weight_and_dispatch_class` [`pallets/utility/src/lib.rs:606–618`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/utility/src/lib.rs#L606-L618).

## Proxy Call Fees

When a call is dispatched through the `proxy` extrinsic, the total transaction fee covers the proxy's own overhead **plus** the inner call's weight. Crucially, the outer extrinsic inherits `pays_fee` and `dispatch_class` directly from the inner call ([`pallets/proxy/src/lib.rs:232–238`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/proxy/src/lib.rs#L232-L238)):
...
**Source code:** deposit formula [`runtime/src/lib.rs:199–204`](https://github.com/RaoFoundation/subtensor/blob/main/runtime/src/lib.rs#L199-L204), constants [`runtime/src/lib.rs:539–543`](https://github.com/RaoFoundation/subtensor/blob/main/runtime/src/lib.rs#L539-L543), deposit calculation [`pallets/proxy/src/lib.rs:964–971`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/proxy/src/lib.rs#L964-L971).
...
Up to 75 pending announcements are allowed per account (`MaxPending`). **Source code:** [`runtime/src/lib.rs:546–549`](https://github.com/RaoFoundation/subtensor/blob/main/runtime/src/lib.rs#L546-L549).
...
**Code references:** Runtime [`SwapRuntimeApi`](https://github.com/RaoFoundation/subtensor/blob/main/runtime/src/lib.rs) (`sim_swap_tao_for_alpha`, `sim_swap_alpha_for_tao`); swap pallet [`sim_swap`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/swap/src/pallet/impls.rs); SDK [`sim_swap`](https://github.com/RaoFoundation/bittensor/blob/main/bittensor/core/subtensor.py) and btcli `subtensor_interface.sim_swap`; chain_data [`SimSwapResult`](https://github.com/RaoFoundation/bittensor/blob/main/bittensor/core/chain_data.py).
...
1. **The transaction fee is charged upfront.**
   Before the extrinsic executes, the runtime deducts the weight + length fee from the coldkey’s TAO free balance ([`withdraw_fee`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/transaction-fee/src/lib.rs#L315)). If the balance is insufficient, the transaction is rejected immediately.
   - **Weight fee:** $\text{weight} \times (50{,}000 / 10^9)$ rao ([`LinearWeightToFee`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/transaction-fee/src/lib.rs#L43-L56): `Perbill::from_parts(50_000)`).
   - **Length fee:** 1 rao per byte of the encoded extrinsic ([`LengthToFee = IdentityFee`](https://github.com/RaoFoundation/subtensor/blob/main/runtime/src/lib.rs#L564)).

2. **The move executes.**
   [`do_move_stake`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/staking/move_stake.rs#L30) calls [`transition_stake_internal`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/staking/move_stake.rs#L298), which runs two swaps because origin and destination subnets differ:
   - **Unstake on origin (subnet 5):** [`unstake_from_subnet`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/staking/move_stake.rs#L358) converts the alpha to TAO, taking a **swap fee** in alpha (`drop_fee_origin`).
   - **Stake on destination (subnet 18):** [`stake_into_subnet`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/staking/move_stake.rs#L376) converts that TAO to alpha with no swap fee (`drop_fee_destination = true`). Only one liquidity fee is charged per move.

3. **Which side pays the swap fee depends on the origin.**
   [`drop_fee_origin = origin_netuid == NetUid::ROOT`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/staking/move_stake.rs#L354-L355), `drop_fee_destination = !drop_fee_origin`:
...
The `move_stake` extrinsic has a declared weight of ([`dispatches.rs`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/subtensor/src/macros/dispatches.rs#L1557-L1559)):
...
The encoded extrinsic includes the call index, two account IDs (32 bytes each), two netuids, and an alpha amount. A typical size is on the order of 100–200 bytes. At 1 rao per byte ([`LengthToFee = IdentityFee`](https://github.com/RaoFoundation/subtensor/blob/main/runtime/src/lib.rs#L564)):

- Length fee ≈ **100–200 rao**.

**3. Swap fee (liquidity component)**  
For subnet 5 (mechanism 1), the fee is $\text{alpha\_amount} \times (\text{FeeRate}(\text{netuid}) / 65{,}535)$ ([`calculate_fee_amount`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/swap/src/pallet/impls.rs#L367) for mechanism 1), where 65,535 is the maximum possible fee rate value. With the default [`DefaultFeeRate`](https://github.com/RaoFoundation/subtensor/blob/main/pallets/swap/src/pallet/mod.rs#L78) of 33:
